...
function ImageComponent ({image, price}) {
    ...
    return(
        <React.Fragment>
            ...
            { name && <ProductNameComponent name={name}/>}
            <img 
